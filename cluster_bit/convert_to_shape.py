...
def plot_pixel_matrix(pixel_matrices, title="Pixel Matrices"):
    ...
    for ax, pixel_matrix in zip(axes, pixel_matrices):
...
def converter(decimal_numbers):
    ...
    # 绘制所有恢复的像素矩阵
    plot_pixel_matrix(pixel_matrices, title="Recovered Pixel Matrices")
